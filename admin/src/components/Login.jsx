    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 flex items-center justify-center px-4 py-8'>
      ...
      <div className='w-full max-w-md'>
        ...
        <div className='text-center mb-8'>
          {/* <div className='inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-lg mb-4'>
        ...
        <div className='bg-white rounded-2xl shadow-xl p-8 border border-gray-200'>
          ...
          <form onSubmit={handleSubmit} className='space-y-5'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <a href='#' className='text-sm font-semibold text-gray-800 hover:text-gray-600 transition-colors'>
                Forgot Password?
              </a>
            </div> */}
