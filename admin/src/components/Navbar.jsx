  ...
  return (
    <div className='flex items-center justify-between py-4 px-8 bg-gradient-to-r from-white to-gray-50 border-b border-gray-200 shadow-sm'>
      ...
      <div className='flex items-center gap-4'>
        ...
        {/* Logout Button */}
        <button 
        className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-red-500 to-red-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:from-red-600 hover:to-red-700 hover:shadow-lg transition-all duration-200 transform hover:scale-105"
        onClick={() => setToken("")}  
        >
